...
namespace TestEstante
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            //Estante.GuardarEstante(est2);
            //Estante.SerializarEstante(est1);
            //Estante.SerializarEstante(est2);
            //Estante.DeserializarEstante(est1);
            //Estante.DeserializarEstante(est2);
            ...
            est1.GetProductos().Sort(Program.OrdenarProducto);
        ...
        public static int OrdenarProducto(Producto prodUno, Producto prodDos)
        {
            int retorno = 0;
            if ((int)prodUno > (int)prodDos)
            {
                retorno= 1;
            }
